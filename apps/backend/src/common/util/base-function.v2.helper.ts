...
export class BaseFunctionHelperV2 {
  bkUserRepo: Repository<BakongUserV2>
  logger: Logger

  constructor(bkUserRepo: Repository<BakongUserV2>, logger: Logger) {
  ...
  async findUserByAccountId(accountId: string): Promise<BakongUserV2 | null> {
  ...
  filterValidFCMUsers(validUsers: BakongUserV2[], mode: 'individual' | 'shared'): BakongUserV2[] {
    if (mode === 'shared') {
