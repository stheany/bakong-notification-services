import type { CategoryTypeV2 } from '../src/services/categoryTypeApi-v2.ts'
/**
 ...
 */
const generateMockCategoryTypes = (): CategoryTypeV2[] => {
    const categoryTypes: CategoryTypeV2[] = []
...
export const mockCategoryTypes: CategoryTypeV2[] = generateMockCategoryTypes()

/**
 * Realistic mock category types (optional - for better testing)
 * Includes the common category types mentioned in the UI
 */
export const realisticMockCategoryTypes: CategoryTypeV2[] = [
  {
    id: 1,
    name: 'Event',
    icon: PLACEHOLDER_ICON,
