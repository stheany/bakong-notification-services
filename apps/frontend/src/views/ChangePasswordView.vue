      ...
      <div class="card-right">
        ...
        <div class="title-section">
          ...
          <p class="main-description">
            This is your first login. For security reasons, you must change your
...
<script setup lang="ts">
  ...
  onBeforeRouteLeave((to, from, next) => {
    ...
    ElNotification({
      ...
      message:
        'You have been logged out. You can login again with your temporary password, but you must change it to access the system.',
      type: 'warning',
      duration: 5000,
    });
