...
import { mockCategoryTypes } from '../../data-mock/mock-category.ts'
...
const categoryToDelete = ref<CategoryTypeV2 | null>(null)
...
const viewItem = (item: any) => {
  const categoryType = item.categoryType as CategoryTypeV2
  if (categoryType) {
