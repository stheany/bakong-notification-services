        ...
        <div class="rounded-2xl p-4 sm:p-6 lg:p-8 w-full h-auto opacity-100">
          <div class="flex flex-col gap-3">
            ...
            <div
              ...
              class="text-xs leading-snug text-red-500 mt-1"
            >
        ...
        <div class="lg:block flex items-center justify-center px-4 sm:px-6">
          <div class="flex flex-col items-center justify-center w-full">
            ...
            >
              ...
              >
                <div
                  class="absolute -top-12 sm:-top-15 left-1/2 transform -translate-x-1/2 z-10"
                >
                  <h3
                ...
                >
                  ...
                  <div
                    v-else
                    class="w-full h-full flex items-center justify-center bg-[#f0f0f0]"
                  >
