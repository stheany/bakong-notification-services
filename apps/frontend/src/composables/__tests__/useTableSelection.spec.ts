...
describe('useTableSelection', () => {
  it('initializes with no items selected', () => {
    ...
    const { selectedItems, isAllSelected, isIndeterminate } =
  ...
  it('selects all items when handleSelectAll is called', () => {
    const items = ref([{ id: 1 }, { id: 2 }, { id: 3 }]);
    const { handleSelectAll, isAllSelected, getSelectedIndices } =
      useTableSelection(items);
  ...
  it('clears selection when clearSelection is called', () => {
    const items = ref([{ id: 1 }, { id: 2 }, { id: 3 }]);
    const { handleSelectItem, clearSelection, getSelectedIndices } =
      useTableSelection(items);
  ...
  it('handles empty items array', () => {
    const items = ref([]);
    const { isAllSelected, isIndeterminate, handleSelectAll } =
      useTableSelection(items);
